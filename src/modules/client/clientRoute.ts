...
import { ClientPaginationSchema, createClientSchema, ClientIdSchema } from "./clientSchema";
...
router.patch("/statut/:id", validate(ClientIdSchema, "params"), validate(createClientSchema, "body"), clientController.updateStatut);
