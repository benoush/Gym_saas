...
import {notifType} from "../../enum/notifType"
...
class Notif extends Model<NotifAttributes, NotifCreationAttributes> implements NotifAttributes{
    ...
    declare notification_type:notifType;
    ...
    Notif.init(
        {
            ...
            notification_type:{
        type: DataTypes.ENUM(...Object.values(notifType)),
                allowNull:false
            },
            content:{
...
//     Notif.belongsTo(models.User, { foreignKey: 'userId', as: 'user' });
// };
